...
if raw_df is not None:
    st.toast(f"Data Up-to-Date: {len(raw_df)} hours loaded", icon="✅")
    ...
    # Tabs
    tab1, tab2, tab3 = st.tabs(["📊 Interactive Dashboard", "🍿 Hall of Panic", "📋 Raw Data"])
    ...
    with tab2:
        st.markdown("### 🎢 The History of Volatility")
        ...
        for event in DEPEG_EVENTS:
            ...
            <div class="history-card" style="border-left: 5px solid {border_color}">
                ...
                <div style="display: flex; justify-content: space-between; font-size: 0.9em;">
                    ...
                    <a href="{event['link']}" target="_blank" style="text-decoration:none;">Read More ↗</a>
                </div>
            </div>
            """, unsafe_allow_html=True)
